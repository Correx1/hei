  ...
  return (
    <footer className="relative bg-[#1a1a1a] text-white pt-64 md:pt-48 lg:pt-36 pb-12 mt-48 md:mt-32">
      ...
      <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[90%] max-w-5xl bg-gradient-to-r from-brand-red to-[#b30000] rounded-2xl shadow-2xl p-8 md:p-12 flex flex-col lg:flex-row items-center justify-between gap-8 z-20 overflow-hidden">
        ...
        <Link 
          href="/donate" 
          className="shrink-0 relative z-10 bg-brand-yellow text-brand-dark font-black font-sans text-sm tracking-wider uppercase px-10 py-5 rounded hover:bg-white transition-all shadow-lg hover:shadow-xl hover:-translate-y-1"
        >
          Donate Now
        </Link>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-4 space-y-6">
            <h3 className="font-heading font-black text-2xl tracking-tighter uppercase text-white leading-none">
              Health Emergency<br/>
              <span className="text-brand-light-blue">Initiative</span>
            </h3>
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <ul className="space-y-3 font-sans text-[14.5px] text-white/60">
              <li><Link href="/who-we-are" className="hover:text-brand-light-blue transition-colors flex items-center gap-2"><span className="text-brand-light-blue/50 text-[10px]">▶</span> Who We Are</Link></li>
              <li><Link href="/what-we-do" className="hover:text-brand-light-blue transition-colors flex items-center gap-2"><span className="text-brand-light-blue/50 text-[10px]">▶</span> What We Do</Link></li>
              <li><Link href="/projects" className="hover:text-brand-light-blue transition-colors flex items-center gap-2"><span className="text-brand-light-blue/50 text-[10px]">▶</span> Our Projects</Link></li>
              <li><Link href="/media" className="hover:text-brand-light-blue transition-colors flex items-center gap-2"><span className="text-brand-light-blue/50 text-[10px]">▶</span> Media Center</Link></li>
              <li><Link href="/membership" className="hover:text-brand-light-blue transition-colors flex items-center gap-2"><span className="text-brand-light-blue/50 text-[10px]">▶</span> Become a Member</Link></li>
            </ul>
          </div>
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <ul className="space-y-4 font-sans text-[14.5px] text-white/60">
              <li className="flex items-start gap-4">
                <MapPin size={20} className="text-brand-light-blue shrink-0 mt-0.5" />
                <span className="leading-relaxed">123 Medical Avenue, Victoria Island,<br/>Lagos, Nigeria.</span>
              </li>
              <li className="flex items-center gap-4">
                <Phone size={20} className="text-brand-light-blue shrink-0" />
                <span>+234 706 398 5777</span>
              </li>
              <li className="flex items-center gap-4">
                <Mail size={20} className="text-brand-light-blue shrink-0" />
          ...
          <div className="lg:col-span-3 space-y-6">
            ...
            <form className="flex flex-col gap-3" onSubmit={(e) => e.preventDefault()}>
              ...
              <button 
                type="submit" 
                className="w-full bg-brand-blue hover:bg-brand-light-blue text-white font-bold font-sans text-sm uppercase tracking-widest py-3.5 rounded transition-colors"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="font-sans text-[13px] text-white/40 text-center md:text-left">
            &copy; {new Date().getFullYear()} Health Emergency Initiative. All rights reserved. <span className="italic block mt-1 md:inline md:mt-0 md:ml-2">"That none should die."</span>
          </p>
